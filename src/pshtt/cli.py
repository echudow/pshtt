...
Usage:
  pshtt (INPUT ...) [--output OUTFILE] [--sorted] [--json] [--markdown] [--debug] [--timeout TIMEOUT] [--user-agent AGENT] [--cache-third-parties DIR] [--ca-file PATH] [--pt-int-ca-file PATH] [--adfs-hsts]
  pshtt (-h | --help)
...
Options:
  ...
  -p --pt-int-ca-file=PATH      Specify public trust CA bundle with intermediates (PEM format)
     --adfs-hsts                Enables scanning special ADFS URLs for HSTS
